# This Makefile is for the MLDBM::TinyDB extension to perl.
#
...
#	NAME => q[MLDBM::TinyDB]
#	SKIP => [q[static], q[dynamic]]
#	VERSION_FROM => q[lib/MLDBM/TinyDB.pm]
...
AR_STATIC_ARGS = cr
NAME = MLDBM::TinyDB
DISTNAME = MLDBM-TinyDB
NAME_SYM = MLDBM_TinyDB
VERSION = 0.15
VERSION_SYM = 0_15
XS_VERSION = 0.15
INST_BIN = blib\bin
...
FULLEXT = MLDBM\TinyDB
BASEEXT = TinyDB
PARENT_NAME = MLDBM
DLBASE = $(BASEEXT)
VERSION_FROM = lib/MLDBM/TinyDB.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
EXPORT_LIST = TinyDB.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = lib/MLDBM/TinyDB.pm

PM_TO_BLIB = lib/MLDBM/TinyDB.pm \
	$(INST_LIB)\MLDBM\TinyDB.pm
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f  $(INST_LIB)\MLDBM\TinyDB.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"MLDBM-TinyDB\" VERSION=\"0,15,0,0\">\n}. qq{\t<TITLE>MLDBM-TinyDB</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > MLDBM-TinyDB.ppd
